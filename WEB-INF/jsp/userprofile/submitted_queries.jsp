		...
		<div class="row">
			<div class="col-sm-3">
				<jsp:include page="sidemenu.jsp">
					<jsp:param value="submitted_queries" name="item" />
				</jsp:include>
			</div>
			<div class="col-sm-9" id="question_table" style="min-height: 400px;">
				<br />
				<h3 class="ml-2">Asked Questions </h3>
				<jsp:include page="question_submitted.jsp">
