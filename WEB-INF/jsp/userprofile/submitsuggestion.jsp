		...
		<div class="row mt-1">
			<div class="col-sm-3">
				<jsp:include page="sidemenu.jsp">
					<jsp:param value="submitsuggestion" name="item" />
				</jsp:include>
			</div>
			<div class="col-sm-9">
				<div class="card">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="md-form">
											...
											<label for="form76">Your Suggestion</label>
										</div>
									</div>
								</div>
								<!--/.Second row-->
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="md-form">
											...
											<input type="hidden" id="form83" class="form-control validate">
										</div>
									</div>
								</div>
								<!--/.First row-->
...
function resetfields1() {
	...
	function SubmitSuggestion() {
		...
		var suggestion = $('#form76').val().trim();
		var location = $('#form81').val().trim();
		var contact = $('#form82').val().trim();
		if (suggestion != '' && location != '' && contact != '' && subject !='') {
			$.post(
					'<%=host + docBase%>/insert/<%= user.getAadharId()%>/submit_suggestion',
					{
						action : 'insert',
						subject : subject,
					...
					function(response) {
						...
						if (response == 'success') {
							showresponsemessage(
									'#suggestion-message',
									'Thank you for your response. We have stored your suggestion for reference.',
									'alert-success');
							resetfields1();
