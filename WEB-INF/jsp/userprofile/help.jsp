...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                           ...
                           <li>
                            <a href="/GovtJobPortal2/home"><i class="fa fa-dashboard fa-fw"></i>How to Register</a>
                            </li>
                       <li>
                            <a href="/GovtJobPortal2/company_detail"><i class="fa fa-edit fa-fw"></i> How to Login</a>
                        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-8">
                    <div class="panel panel-green">
                        ...
                        <a href="/GovtJobPortal2/job_list">
                   ...
                   <div class="col-lg-4 col-md-8">
                    <div class="panel panel-green">
                        ...
                        <a href="/GovtJobPortal2/company_list">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
	...
	<script type="text/javascript" src="<c:url value="/resources/vendor/raphael/raphael.min.js"/>"/></script>
