...
<link
	...
	rel="stylesheet">
<link
	href="https://fonts.googleapis.com/css?family=Roboto:300i,400,400i,500,500i|Slabo+27px"
	rel="stylesheet">
<!-- Bootstrap -->
<link href="<%=host + docBase%>/mdb/css/bootstrap.min.css"
	rel="stylesheet">
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-8" id="companytable" style="min-height: 400px;">
			...
			<div class="col-sm-2">
				<div class="panel panel-primary">
					<div class="panel-heading"><a style="background-color: rgb(2, 117, 216); color: rgb(255, 255, 255); padding: 10px; border-radius: 5px;"href="<%= user!=null?(host+docBase+"/user/"+user.getAadharId()+"/submitsuggestion"):"login" %>">Submit Suggestion</a></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript"
		src="<%=host + docBase%>/js/jquery.min.js"></script>
	<script type="text/javascript"
		src="<%=host + docBase%>/mdb/js/tether.min.js"></script>

	<!-- Bootstrap core JavaScript -->
	<script type="text/javascript"
		src="<%=host + docBase%>/mdb/js/bootstrap.min.js"></script>

	<!-- MDB core JavaScript -->
	<script type="text/javascript"
		src="<%=host + docBase%>/mdb/js/mdb.min.js"></script>
		<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$(document).on('click','.fa-thumbs-down', function(){
				...
				<% if(user!=null){%>
				$.post(
					'<%=host+docBase%>/dislike/<%= user.getAadharId()%>/suggestion',
					{
						suggestion_id: id
					},
					function(response){
